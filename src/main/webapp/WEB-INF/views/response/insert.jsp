...
<!DOCTYPE html>
    ...
    <body>
        ...
        <div class="d-flex justify-content-center">
            ...
            <div id="inquiries" >
                <h1 style="text-align: center; margin-top: 50px;">문의글 답변 작성</h1><br>
                ...
                <div class="respones inquiries">
                    <form action="/admin/insertresponse.tp" method="post">
                    	<input type="hidden" name="inquiryNo" value="${iPost.inquiryNo }" />
                       	<textarea id="responseContent" name="responseContent" style="height: 500px;"></textarea>
