                ...
                <div class="flex">
                	<form name="registerForm" action="/user/register.tp"  method="post">
	                    <div>
	                        ...
	                        <button type="button" onclick="idCheck();" class="btn btn-light btn-sm">중복 확인</button>
	                    </div>
						<c:if test="${not empty msg}">
	                        <span id="" class="checkMsg" style="color: red">
	                            <!-- ${msg} -->
	                        </span>
						</c:if>
