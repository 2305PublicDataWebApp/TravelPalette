        ...
        <div class="flex">
	        <c:if test="${sessionScope.platformType == 'normal'}">
	            ...
	            <div class="loginBox">
	                ...
	                <div class="btnBox">
	                    <button type="button" class="btn btn-info loginBtn" onclick="normalBtn()">${btnMsg }</button>
	                </div>
	            </div>
	        </c:if>
	        <c:if test="${sessionScope.platformType == 'kakao'}">
	            ...
	            <div class="loginBox">
	                ...
	                <div class="btnBox">
	                    <button type="button" class="btn btn-info loginBtn" onclick="kakaoBtn()">${btnMsg }</button>
	                </div>
	            </div>	        
	        </c:if>
        <!-- 푸터 -->
