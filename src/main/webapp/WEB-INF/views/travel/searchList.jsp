        ...
        <main>      	
            <div class="leftBox">
                <div class="ListTitle">
                    ...
                    <p style="font-size: 30px; font-weight: bold; padding-bottom: 5px; ">검색결과</p>
                </div>
                <div class="totalCheck" style="font-size: 20px;">
                    <b>총<span id="totalCount">${totalCount }</span>건</b>
                    <ul style="float: right;">
                        <li><a href="/travel/search.tp?order=latest">최신순</a></li>
        				<li><a href="/travel/search.tp?order=views">조회순</a></li>
        				<li><a href="/travel/search.tp?order=popular">인기순</a></li>
                    </ul>
                </div>
                <!-- 리스트출력 -->
                <div class="list">
