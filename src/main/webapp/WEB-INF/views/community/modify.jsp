            ...
            <form action="/community/insert.tp" method="post">
                <div style="width: 100%;margin: 0 auto;">
                    <div class="form-floating mb-3">
                        ...
                        <label for="floatingInput">${community.boardTitle }</label>
                      </div>
                </div>
                 ...
                 <div class="form-floating">
                    <textarea name="boardContent" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px;border: 1px solid #ccc;margin-top: 25px;height: 500px;resize: none;">${community.boardContent }</textarea>
                    <label for="floatingTextarea2">comments</label>
                 </div>
                <div style="width: 1000px;margin: 0 auto;text-align: center;margin-top: 70px;">
                    <button class="btn btn-primary btn-lg">수정 완료</button>
                </div>
            </form>
        </main>
